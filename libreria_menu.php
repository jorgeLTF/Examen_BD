...
if ($cuerp== false) {
    echo" <img src='../licoreria/logos/{$logo_licoreria}' width='10%' >";
}
else {
echo" <img src='privada/licoreria/logos/{$logo_licoreria}' width='10%' >";
}
...
echo"<html>
    <head>";
if ($cuerp == false)
echo"<link rel='stylesheet 'href='../../css/menu_desplegable.css' type='text/css'>"; else
        ...
        foreach ($rs2 as $t => $fila2) {
            if ($grup == $fila2["grupo"]) {
                if ($cuerp == false or $cuerp == "") {
                    ...
                    echo "<li><a onclick='location.href=\"sis_licoreria2_2022/" .$fila2["contenido"], "\"' style='cursor:pointer;'>" .$fila2["opcion"]. "</a></li>";
            }
        }
        echo "</ul>";
        echo "</li>";
